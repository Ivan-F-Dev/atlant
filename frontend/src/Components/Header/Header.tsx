...
const Header: FC<HeaderProps> = ({ active, setActive }) => {
	...
	return <div className={s.header}>
		<div className={s.headerContainer}>
			<div className={s.logo}>	<NavLink to={ROUTES.HOME}>Atlant Crypto</NavLink></div>
			<Navbar/>
			<div className={s.settingsButton} onClick={setActive}>
				<svg className={s.settingsIcon} fill="#32BEA6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="64px" height="64px">
			...
			<div className={s.user}>
				<div className={s.userAvatar}>
					<a><img className={s.profilePhoto} src={ProfilePhoto} alt="аватар" /></a>
				</div>
				<div className={s.userInfo}>
					<div className={s.userName}>Владимир Владимирович Путин</div>
				</div>
			</div>
		</div>
	</div>
